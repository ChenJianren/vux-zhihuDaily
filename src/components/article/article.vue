<template>
  <div class="wrapper">
    <sticky>
    <x-header :left-options="{backText: ''}" >{{title}} <a slot="right" @click="right()">收藏</a></x-header>
  </sticky>
    <view-box ref="viewBox">
      <div class="news-content" v-html="body"></div>
    </view-box>
    <XButton  @click.native="backTop">返回顶部</XButton>
  </div>
</template>
<script>
import {
  ViewBox,XHeader,XButton,Sticky,Toast
} from 'vux'
import Vue from 'vue'
export default {
  components: {
  ...
  beforeRouteEnter(to, from, next) {
    let url = 'https://news-at.zhihu.com/api/4/news/'+ to.params.article_id
    Vue.http.get('https://bird.ioliu.cn/v1/?url=' + url)
      .then(function(res) {
        let _body = res.data
...
/*! normalize.css v2.1.0 | MIT License | git.io/normalize */article,aside,details,figcaption,figure,footer,header,hgroup,main,nav,section,summary{display:block}audio,canvas,video{display:inline-block}audio:not([controls]){display:none;height:0}[hidden]{display:none}html{font-family:sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%}body{margin:0}a:focus{outline:thin dotted}a:active,a:hover{outline:0}h1{margin:.67em 0}h1,h2,h3,h4,h5,h6{font-size:18px}abbr[title]{border-bottom:1px dotted}b,strong{font-weight:bold}dfn{font-style:italic}hr{-moz-box-sizing:content-box;box-sizing:content-box;height:0}mark{background:#ff0;color:#000}code,kbd,pre,samp{font-family:monospace,serif;font-size:1em}pre{white-space:pre-wrap}q{quotes:"\201C" "\201D" "\2018" "\2019"}small{font-size:80%}sub,sup{font-size:75%;line-height:0;position:relative;vertical-align:baseline}sup{top:-0.5em}sub{bottom:-0.25em}img{border:0}svg:not(:root){overflow:hidden}figure{margin:0}fieldset{border:1px solid #c0c0c0;margin:0 2px;padding:.35em .625em .75em}legend{border:0;padding:0}button,input,select,textarea{font-family:inherit;font-size:100%;margin:0}button,input{line-height:normal}button,select{text-transform:none}button,html input[type="button"],input[type="reset"],input[type="submit"]{-webkit-appearance:button;cursor:pointer}button[disabled],html input[disabled]{cursor:default}input[type="checkbox"],input[type="radio"]{box-sizing:border-box;padding:0}input[type="search"]{-webkit-appearance:textfield;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;box-sizing:content-box}input[type="search"]::-webkit-search-cancel-button,input[type="search"]::-webkit-search-decoration{-webkit-appearance:none}button::-moz-focus-inner,input::-moz-focus-inner{border:0;padding:0}textarea{overflow:auto;vertical-align:top}table{border-collapse:collapse;border-spacing:0}
.sprite-ico-Header_Logo2x,
.sprite-ico-Button_iPhone2x,
.sprite-ico-Button_Android2x,
.sprite-ico-Arrow_Right2x,
.sprite-ico-News_Arrow2x,
.sprite-ico-Dark_News_Arrow2x{background-image:url('/img/share-icons.png');background-repeat:no-repeat;display: inline-block;vertical-align: middle;}.sprite-ico-Header_Logo2x{background-position:0px 0px;width:53px;height:55px;}
.sprite-ico-Button_iPhone2x{background-position:-53px 0px;width:17px;height:20px;}
.sprite-ico-Button_Android2x{background-position:-53px -20px;width:17px;height:20px;}
.sprite-ico-Arrow_Right2x{background-position:-70px 0px;width:12px;height:20px;}
.sprite-ico-News_Arrow2x{background-position:-70px -20px;width:10px;height:15px;}
.sprite-ico-Dark_News_Arrow2x{background-position:-70px -35px;width:10px;height:15px;}
@media only screen and (-webkit-min-device-pixel-ratio: 2.0), only screen and (min--moz-device-pixel-ratio: 2.0), only screen and (-o-min-device-pixel-ratio: 200/100), only screen and (min-device-pixel-ratio: 2.0) {.sprite-ico-Header_Logo2x,
.sprite-ico-Button_iPhone2x,
.sprite-ico-Button_Android2x,
.sprite-ico-Arrow_Right2x,
.sprite-ico-News_Arrow2x,
.sprite-ico-Dark_News_Arrow2x{background-image:url('/img/share-icons@2x.png');-webkit-background-size: 82px 55px;-moz-background-size: 82px 55px;background-size: 82px 55px;}}
body {
    background: #f6f6f6;
    padding-top: 60px;
